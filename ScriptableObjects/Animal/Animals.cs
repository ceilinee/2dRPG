...
public class Animals : ScriptableObject
{
  ...
  string newHome, int newCost, bool newPregnant, int newDeliveryDate, int[] newBabyId, float newLove, string newBreed, string scene, bool charOwned, int charId, AnimalColors animalColors, Animal.Personality personality,  int _momId, int _dadId){
